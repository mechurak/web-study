...
- Express와 비교해 NestJS가 강제하는 구조(모듈/DI/데코레이터)는 무엇을 좋게 만드는가?
...
| 2 | [02-rest-api.md](./notes/02-rest-api.md) | DTO, 검증(Pipe), 예외 처리 |
| 3 | [03-database.md](./notes/03-database.md) | Prisma/TypeORM으로 Supabase Postgres 연결 |
| 4 | [04-auth.md](./notes/04-auth.md) | Guard, JWT, Supabase 토큰 검증 |
